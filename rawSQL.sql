...
create table `siswas` (`id` bigint unsigned not null auto_increment primary key, `nama` varchar(255) not null, `alamat` varchar(255) not null, `created_at` timestamp null, `updated_at` timestamp null) default character set utf8mb4 collate 'utf8mb4_unicode_ci';
create table `todos` (`id` char(36) not null, `title` varchar(255) not null, `done` tinyint(1) not null, `created_at` datetime not null, `updated_at` datetime not null) default character set utf8mb4 collate 'utf8mb4_unicode_ci';;
alter table `todos` add primary key `todos_id_primary`(`id`);
